          ...
          <div className="content col-span-1 flex flex-col justify-between">
            <div className="">
              <span className="bg-white p-5  !inline-flex items-center rounded-2xl mb-5 md:m-0">
                <FileDoneOutlined
                  style={{ fontSize: "32px", color: "#ef7123" }}
                  className=""
                />
              </span>
            </div>
            <h2 className="text-white font-bold text-4xl mb-5 md:m-0 ">
              APPLY TO ONE OF OUR Jobs POSTINGS TODAY
            </h2>
            <div className="">
              <button className=" text-lg  px-5 py-3 bg-white rounded-lg ">
                Apply Now
              </button>
            </div>
          </div>

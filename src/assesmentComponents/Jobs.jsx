      ...
      <div className="bg-[#8F9AA3] p-5 md:px-20 md:py-16">
        <div className="md:grid grid-cols-12">
          <div className="content col-span-3 flex flex-col justify-between">
            ...
            <div className="">
              <h2 className="text-white font-bold text-xl uppercase mb-5">
                Provo
              </h2>
              <h2 className="text-white font-bold text-xl uppercase mb-5">
                Roy
          ...
          <div className="cards grid grid-cols-12 gap-7 col-span-9">
            {Jobss.map((Jobs) => (
              <div
                key={Jobs.id}
                className="group card col-span-12  md:col-span-6 lg:col-span-4 h-52 bg-[#E3E8ED] p-4 flex justify-between flex-col rounded-2xl hover:bg-[#ef7123] hover:scale-105 ease-in-out duration-500 "
              >
                <div className="flex justify-between ">
                  <div className=" rounded-md">
                    <h2 className="bg-white px-3 py-1 rounded-md">
                      {Jobs.type ? "Temp to Full-Time" : "Temp"}
                    </h2>
                  </div>
                  <div className="bg-white px-3 py-2 rounded-md">
                    <IdcardOutlined
                      style={{ fontSize: "24px", color: "#ef7123" }}
                    />
                  </div>
                </div>
                <h2 className="text-lg  group-hover:text-white">{Jobs.name}</h2>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center">
          <button className="border-2 rounded-lg border-white text-white px-5 py-3 hover:border-[#ef7123] hover:bg-[#ef7123] ease-in-out duration-300 ">
            Explore All the Jobs Openings
          </button>
        </div>
      </div>
    </div>
